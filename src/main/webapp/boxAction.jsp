...
<div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5">
        ...
        <div class="main-card mb-3 card mainCart">
            ...
            <form class="row p-3" id="addOrder">
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <select id="pname" class="selectpicker" data-width="100%" data-show-subtext="true" data-live-search="true">
                        ...
                        <c:forEach items="${utils.allProducts()}" var="item">
                            <option value="<c:out value="${item.pro_id}"></c:out>" data-subtext="<c:out value="${item.pro_id}"></c:out>"><c:out value="${item.pro_title}"></c:out></option>
                        </c:forEach>
                    </select>
                </div>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <input type="number" min="1" max="10000" name="count" id="count" class="form-control" />
                </div>


                <div class="col-md-3 mb-3">
                    <label for="bNo" class="form-label">Fiş No</label>
                    <input type="text" min="1" name="bNo" id="bNo" class="form-control" />
                </div>
